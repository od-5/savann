        ...
        block: function () {
            return {
                ...
                format: function (tag, type, value) {
                    ...
                    var formatTags = ['p', 'pre', 'blockquote', 'strong', 'a', 'figcaption', 'div', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'];
            ...
            return {
                ...
                insert: function (json, direct, e) {
                    ...
                    if (typeof json == 'string') {
                        ...
                        link = '<a class="'+$('#redactor-fileclass').val()+'" href="' + json.filelink + '" id="filelink-marker"><span class="k">' + text + '</span></a>';
                    }
            ...
            return {
                ...
                loadTemplates: function () {
                    this.opts.modal = {
                        ...
                        + '<label>Класс файла</label>'
                        + '<input type="text" id="redactor-fileclass" /><br><br>'
